...
import com.zxg.mvparmsdemo.di.component.DaggerNotificationsComponent;
import com.zxg.mvparmsdemo.di.module.NotificationsModule;
import com.zxg.mvparmsdemo.mvp.contract.NotificationsContract;
import com.zxg.mvparmsdemo.mvp.presenter.NotificationsPresenter;
...
public class NotificationsFragment extends BaseFragment<NotificationsPresenter> implements NotificationsContract.View {
    ...
    public void setupFragmentComponent(AppComponent appComponent) {
        DaggerNotificationsComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .notificationsModule(new NotificationsModule(this))
                .build()
                .inject(this);
    }
