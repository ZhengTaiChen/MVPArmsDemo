...
import com.zxg.mvparmsdemo.di.component.DaggerDashboardComponent;
import com.zxg.mvparmsdemo.di.module.DashboardModule;
import com.zxg.mvparmsdemo.mvp.contract.DashboardContract;
import com.zxg.mvparmsdemo.mvp.presenter.DashboardPresenter;
...
public class DashboardFragment extends BaseFragment<DashboardPresenter> implements DashboardContract.View {
    ...
    public void setupFragmentComponent(AppComponent appComponent) {
        DaggerDashboardComponent //如找不到该类,请编译一下项目
                .builder()
